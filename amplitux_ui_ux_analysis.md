# Amplitux UI/UX Design System — Complete Analysis
...
background-image: linear-gradient(
  244deg,
  var(--brand--aqua-30),   /* teal 30% */
  var(--brand--aqua-20) 99.26%  /* teal 20% */
);
```
...
- **Fallback**: `sans-serif`
- Body font explicitly set: `font-family: Inter, sans-serif;` *(Note: CSS also references `Geist` in one base class, but Inter is the primary loaded font)*
...
```css
box-shadow: 0 4px 9px #00000008, 0 17px 17px #00000008, 0 38px 23px #00000005, 0 67px 27px #00000003;
```
...
```css
.nav_links { opacity: 0.7; transition: opacity 0.3s; }
.nav_links:hover { opacity: 1; }
```
